...
jDesktopPane1.add(JanelaCadastro);
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        ...
        BuscarGenero JanelaListar = new BuscarGenero();
        
        JanelaListar.setVisible(true);

        jDesktopPane1.add(JanelaListar);

    }//GEN-LAST:event_btnListarActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
  
        ListadeFilmes JanelaBuscar = new ListadeFilmes();
        
        JanelaBuscar.setVisible(true);

        jDesktopPane1.add(JanelaBuscar);
...
jDesktopPane1.add(JanelaEditar);
